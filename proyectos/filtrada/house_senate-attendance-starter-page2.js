                ...
                var rellenarTabla = function(){ //hacemos una funcion, y dentro de estas, que se ejecuten los jquery, para que en la id elegida, coja del data.js, los datos conseguidos en el bucle anterior, y te los introduce en la tabla.
                    ...
                    $("#reps_pct").html(stadistics.republicans.votes_pct + "%"); //añade con Jquery en el html, en la id señalada los datos conseguidos por el bucle y en el caso de este le añadimos el "%", ya que hablamos de porcentaje, y se añade en la tabla seleccionada del html
